function CMyCanvasWindowCommon()
{
	...
	this.m_nCanvasBorderWidthSideArc = 10; // the width of the side arc border. it is the height of the arc on one side.
	this.m_nCanvasBorderWidthCorner  = 10; // the width of the corner border. it is the radius of the corner circle.
